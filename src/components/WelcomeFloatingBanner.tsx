...
const ONBOARDING_DISMISSED_KEY = 'selalu_aktif_onboarding_dismissed_v1';
...
export const WelcomeFloatingBanner: React.FC<Props> = ({ onStartTour }) => {
  ...
  useEffect(() => {
    ...
    if (!isDismissed) {
      // Delay entrance slightly for delight
      ...
      <div className="glass-brutal-panel rounded-3xl p-5 border-2 border-cyan-500/50 shadow-brutal-cyan relative overflow-hidden">
        ...
        <div className="mt-2.5">
          <h4 className="text-sm font-extrabold text-white flex items-center gap-1.5">
            <span>Baru Pertama Kali di Sini?</span>
            <span className="text-xs">👋</span>
          </h4>
          <p className="text-xs text-slate-300 font-sans mt-1 leading-relaxed">
            Lihat panduan interaktif 5 tahap mudah untuk menyiapkan Master Hub dan menjaga seluruh database Supabase Anda tetap aktif 24/7.
          </p>
        </div>

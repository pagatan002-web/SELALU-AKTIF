    ...
    <div className="glass-brutal-panel rounded-3xl p-5 sm:p-6 mt-8">
      ...
      <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
        ...
        {logs.length > 0 && (
          <button
            onClick={onClearLogs}
            className="text-xs text-slate-400 hover:text-rose-400 flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-800 hover:border-rose-900/60 bg-slate-900/60 transition-all font-mono"
              ...
              {logs.map((log) => (
                <tr key={log.id} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-2.5 whitespace-nowrap">
                    <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded bg-slate-800 border border-slate-700 text-cyan-300">
                  ...
                  <td className="py-2.5 text-slate-400 max-w-xs truncate hidden sm:table-cell">
